...
description: Check whether a ticket-scoped pull request is merged, delete the branch if it still exists, switch to main, and pull the latest main branch. Use it for prompts like "PR for FMH-5 is now merged".
---
...
6. Report back what was deleted and whether `main` was updated.
